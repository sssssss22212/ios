...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> MAGIC_LANTERN = BLOCKS.register("magic_lantern",
        () -> new Block(AbstractBlock.Properties.of(Material.GLASS).strength(0.3f).sound(SoundType.GLASS).noOcclusion().lightLevel(s->12)));
    ...
    // HELPERS
    // ═══════════════════════════════════════
    private static RegistryObject<Block> stone(String n, float h, float r) {
        return BLOCKS.register(n, () -> new Block(
            AbstractBlock.Properties.of(Material.STONE).strength(h,r).sound(SoundType.STONE)));
    }
    private static RegistryObject<Block> metal(String n, float h, float r) {
        return BLOCKS.register(n, () -> new Block(
            AbstractBlock.Properties.of(Material.METAL).strength(h,r).sound(SoundType.METAL)));
    }
    private static RegistryObject<Block> ore(String n, float h) {
        return BLOCKS.register(n, () -> new OreBlock(
            AbstractBlock.Properties.of(Material.STONE).strength(h,h).sound(SoundType.STONE).requiresCorrectToolForDrops()));
    }
