...
public class GemForgeScreen extends ContainerScreen<GemForgeContainer> {
    private static final ResourceLocation BG = new ResourceLocation("decorativeblocks", "textures/gui/gem_forge.png");

    public GemForgeScreen(GemForgeContainer container, PlayerInventory inv, ITextComponent title) {
