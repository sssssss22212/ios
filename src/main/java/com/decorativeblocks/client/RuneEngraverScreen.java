...
public class RuneEngraverScreen extends ContainerScreen<RuneEngraverContainer> {
    private static final ResourceLocation BG =
        new ResourceLocation("decorativeblocks", "textures/gui/rune_engraver.png");

    public RuneEngraverScreen(RuneEngraverContainer c, PlayerInventory inv, ITextComponent title) {
        super(c, inv, title);
