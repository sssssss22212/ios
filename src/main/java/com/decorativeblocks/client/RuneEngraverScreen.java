...
public class RuneEngraverScreen extends ContainerScreen<RuneEngraverContainer> {
    private static final ResourceLocation BG = new ResourceLocation("decorativeblocks", "textures/gui/rune_engraver.png");

    public RuneEngraverScreen(RuneEngraverContainer container, PlayerInventory inv, ITextComponent title) {
